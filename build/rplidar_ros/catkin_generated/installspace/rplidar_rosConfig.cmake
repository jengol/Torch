...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rplidar_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jengol/catkin_ws/install/${idir}'.  Ask the maintainer 'Slamtec ROS Maintainer <ros@slamtec.com>' to fix it.")
    endif()
