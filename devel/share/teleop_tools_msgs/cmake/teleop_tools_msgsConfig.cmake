...
if("TRUE" STREQUAL "TRUE")
  set(teleop_tools_msgs_SOURCE_PREFIX /home/jengol/catkin_ws/src/teleop_tools/teleop_tools_msgs)
  set(teleop_tools_msgs_DEVEL_PREFIX /home/jengol/catkin_ws/devel)
  ...
  set(teleop_tools_msgs_INSTALL_PREFIX /home/jengol/catkin_ws/install)
...
if(NOT "/home/jengol/catkin_ws/devel/include " STREQUAL " ")
  set(teleop_tools_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/jengol/catkin_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'teleop_tools_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Bence Magyar <bence.magyar.robotics@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'teleop_tools_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jengol/catkin_ws/src/teleop_tools/teleop_tools_msgs/${idir}'.  Ask the maintainer 'Bence Magyar <bence.magyar.robotics@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jengol/catkin_ws/devel/lib;/home/jengol/catkin_ws/devel/lib;/opt/ros/indigo/lib)
...
set(teleop_tools_msgs_EXPORTED_TARGETS "teleop_tools_msgs_generate_messages_cpp;teleop_tools_msgs_generate_messages_lisp;teleop_tools_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${teleop_tools_msgs_dep}_FOUND)
      find_package(${teleop_tools_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${teleop_tools_msgs_dep} REQUIRED ${depend_list})
  endif()
